...
module par_init
  ...
  interface var_zero
     ...
     module procedure cvar3_zero
     module procedure var4_zero
     module procedure cvar4_zero
  ...
  subroutine cvar3_zero(v)
    ...
    do concurrent (k = 1:nk, j = 1:nj, i = 1:ni)
       v(i, j, k) = cmplx(zero, zero, kind=mytype)
    end do
    
  end subroutine cvar3_zero
  !
  ...
  subroutine cvar4_zero(v)
    ...
    do concurrent (l = 1:nl, k = 1:nk, j = 1:nj, i = 1:ni)
       v(i, j, k, l) = cmplx(zero, zero, kind=mytype)
    end do

  end subroutine cvar4_zero
